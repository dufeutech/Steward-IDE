...
Signing key material MUST NOT exist in the source repository, the published repository,
or build artifacts. The online signing key MUST be injected at signing time from a secret

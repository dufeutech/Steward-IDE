...
- `pack-publisher-pipeline` (active) — 4 ADRs (repo signing `tuftool`, hosting GitHub
  Pages — supersedes the GitHub Releases endpoint ADR above, provenance GitHub
  attestations, online-key custody Actions secrets):
